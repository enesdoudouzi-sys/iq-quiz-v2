...
ALLE_FRAGEN = [
    ...
    # ── ALLGEMEINWISSEN NEU ───────────────────────────────────────────────────
    {"kategorie":"Allgemeinwissen","schwierigkeit":1,"frage":"Wie viele Minuten hat eine Stunde?","antworten":{"A":"30","B":"45","C":"60","D":"90"},"richtig":"C","erklaerung":"Eine Stunde hat 60 Minuten – jede Minute hat 60 Sekunden.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":2,"frage":"Was ist die Hauptstadt von Schweden?","antworten":{"A":"Kopenhagen","B":"Helsinki","C":"Oslo","D":"Stockholm"},"richtig":"D","erklaerung":"Stockholm ist die Hauptstadt Schwedens mit ca. 1 Million Einwohnern.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":1,"frage":"Welches Tier ist das groesste Landtier?","antworten":{"A":"Nilpferd","B":"Nashorn","C":"Elefant","D":"Giraffe"},"richtig":"C","erklaerung":"Der Afrikanische Elefant ist das groesste Landtier – bis zu 7.500 kg schwer.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":2,"frage":"Welches Land hat die groesste Bevoelkerung?","antworten":{"A":"China","B":"Indien","C":"USA","D":"Indonesien"},"richtig":"B","erklaerung":"Indien hat China 2023 ueberholt – mit ueber 1,4 Milliarden Einwohnern.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":1,"frage":"Wie viele Jahreszeiten gibt es?","antworten":{"A":"2","B":"3","C":"4","D":"5"},"richtig":"C","erklaerung":"Es gibt 4 Jahreszeiten: Fruehling, Sommer, Herbst und Winter.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":2,"frage":"Was ist die Hauptstadt von Norwegen?","antworten":{"A":"Bergen","B":"Oslo","C":"Stavanger","D":"Trondheim"},"richtig":"B","erklaerung":"Oslo ist die Hauptstadt Norwegens und liegt am Oslofjord.","seq":None},
    {"kategorie":"Allgemeinwissen","schwierigkeit":3,"frage":"Wie heisst die Hauptstadt von Neuseeland?","antworten":{"A":"Auckland","B":"Christchurch","C":"Wellington","D":"Hamilton"},"richtig":"C","erklaerung":"Wellington ist die Hauptstadt Neuseelands – viele denken faelschlicherweise Auckland.","seq":None},

    # ── WISSENSCHAFT NEU ──────────────────────────────────────────────────────
    {"kategorie":"Wissenschaft","schwierigkeit":1,"frage":"Was ist der Aggregatzustand von Wasser bei -10 Grad?","antworten":{"A":"Fluessig","B":"Gasfoermig","C":"Fest","D":"Plasma"},"richtig":"C","erklaerung":"Wasser gefriert bei 0°C – bei -10°C ist es fest (Eis).","seq":None},
    {"kategorie":"Wissenschaft","schwierigkeit":2,"frage":"Welches Organ pumpt das Blut durch den Koerper?","antworten":{"A":"Lunge","B":"Leber","C":"Niere","D":"Herz"},"richtig":"D","erklaerung":"Das Herz pumpt ca. 5 Liter Blut pro Minute durch den Koerper.","seq":None},
    {"kategorie":"Wissenschaft","schwierigkeit":2,"frage":"Was ist der pH-Wert von reinem Wasser?","antworten":{"A":"5","B":"7","C":"9","D":"14"},"richtig":"B","erklaerung":"Reines Wasser hat einen pH-Wert von 7 – das ist neutral.","seq":None},
    {"kategorie":"Wissenschaft","schwierigkeit":3,"frage":"Welches Element hat die Ordnungszahl 1?","antworten":{"A":"Helium","B":"Lithium","C":"Kohlenstoff","D":"Wasserstoff"},"richtig":"D","erklaerung":"Wasserstoff (H) hat die Ordnungszahl 1 – es ist das leichteste Element.","seq":None},
    {"kategorie":"Wissenschaft","schwierigkeit":2,"frage":"Wie schnell faellt ein Objekt im freien Fall (ca.)?","antworten":{"A":"5 m/s²","B":"10 m/s²","C":"15 m/s²","D":"20 m/s²"},"richtig":"B","erklaerung":"Die Erdbeschleunigung betraegt ca. 9,81 m/s² – aufgerundet ca. 10 m/s².","seq":None},
    {"kategorie":"Wissenschaft","schwierigkeit":3,"frage":"Was ist ein Quasar?","antworten":{"A":"Ein Stern","B":"Ein Planet","C":"Aktiver Galaxienkern","D":"Ein Asteroid"},"richtig":"C","erklaerung":"Quasare sind extrem helle aktive Galaxienkerne – die leuchtkraeftigsten Objekte im Universum.","seq":None},

    # ── MATHEMATIK NEU ────────────────────────────────────────────────────────
    {"kategorie":"Mathematik","schwierigkeit":1,"frage":"Was ist 7 x 8?","antworten":{"A":"54","B":"56","C":"58","D":"64"},"richtig":"B","erklaerung":"7 x 8 = 56 – ein klassisches Einmaleins-Ergebnis.","seq":None},
    {"kategorie":"Mathematik","schwierigkeit":2,"frage":"Was ist der Umfang eines Kreises mit Radius 10?","antworten":{"A":"10 Pi","B":"20 Pi","C":"100 Pi","D":"40 Pi"},"richtig":"B","erklaerung":"Umfang = 2 x Pi x r = 2 x Pi x 10 = 20 Pi ≈ 62,83.","seq":None},
    {"kategorie":"Mathematik","schwierigkeit":1,"frage":"Wie viele Grad hat ein rechter Winkel?","antworten":{"A":"45°","B":"90°","C":"120°","D":"180°"},"richtig":"B","erklaerung":"Ein rechter Winkel betraegt genau 90 Grad.","seq":None},
    {"kategorie":"Mathematik","schwierigkeit":2,"frage":"Was ist 15 hoch 2 minus 100?","antworten":{"A":"115","B":"125","C":"225","D":"200"},"richtig":"B","erklaerung":"15² = 225, dann 225 - 100 = 125.","seq":None},
    {"kategorie":"Mathematik","schwierigkeit":3,"frage":"Was ergibt sin(90°)?","antworten":{"A":"0","B":"0,5","C":"1","D":"-1"},"richtig":"C","erklaerung":"sin(90°) = 1 – das Maximum der Sinusfunktion.","seq":None},
    {"kategorie":"Mathematik","schwierigkeit":1,"frage":"Was ist 100 / 4 + 5?","antworten":{"A":"25","B":"28","C":"30","D":"35"},"richtig":"C","erklaerung":"Punkt vor Strich: 100/4 = 25, dann 25+5 = 30.","seq":None},

    # ── LOGIK NEU ─────────────────────────────────────────────────────────────
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":1,"frage":"Welche Zahl kommt als naechstes?\n10 - 20 - 30 - 40 - ?","antworten":{"A":"45","B":"50","C":"55","D":"60"},"richtig":"B","erklaerung":"Es wird immer 10 addiert: 40 + 10 = 50.","seq":"10  20  30  40  ?"},
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":2,"frage":"Welche Zahl fehlt?\n3 - 9 - 27 - 81 - ?","antworten":{"A":"162","B":"216","C":"243","D":"324"},"richtig":"C","erklaerung":"Jede Zahl wird mit 3 multipliziert: 81 x 3 = 243.","seq":"3  9  27  81  ?"},
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":1,"frage":"Analogie: Hund zu Welpe wie Katze zu?","antworten":{"A":"Mieze","B":"Kaetzchen","C":"Kater","D":"Haustier"},"richtig":"B","erklaerung":"Welpe ist das Junge des Hundes – Kaetzchen ist das Junge der Katze.","seq":None},
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":2,"frage":"Welches passt nicht dazu?\nHammer – Schraubenzieher – Zange – Pinsel – Saegemesser","antworten":{"A":"Hammer","B":"Zange","C":"Pinsel","D":"Saegemesser"},"richtig":"C","erklaerung":"Alle anderen sind Werkzeuge zum Bauen/Reparieren – der Pinsel ist ein Malinstrument.","seq":None},
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":3,"frage":"Welche Zahl fehlt?\n2 - 3 - 5 - 8 - 13 - ?","antworten":{"A":"18","B":"19","C":"20","D":"21"},"richtig":"D","erklaerung":"Jede Zahl ist die Summe der zwei vorherigen (Fibonacci): 8+13=21.","seq":"2  3  5  8  13  ?"},
    {"kategorie":"Logik & Zahlenfolgen","schwierigkeit":2,"frage":"Wenn alle Enten Voegel sind und alle Voegel atmen, dann...?","antworten":{"A":"Enten fliegen alle","B":"Alle Enten atmen","C":"Alle Voegel sind Enten","D":"Enten sind Saeugetiere"},"richtig":"B","erklaerung":"Logischer Schluss: Enten → Voegel → atmen, also atmen alle Enten.","seq":None},

    # ── KONZENTRATION NEU ─────────────────────────────────────────────────────
    {"kategorie":"Konzentration","schwierigkeit":1,"frage":"Wie viele Buchstaben hat das Wort MATHEMATIK?","antworten":{"A":"9","B":"10","C":"11","D":"12"},"richtig":"B","erklaerung":"M-A-T-H-E-M-A-T-I-K = 10 Buchstaben.","seq":None},
    {"kategorie":"Konzentration","schwierigkeit":2,"frage":"100 - 37 + 14 = ?","antworten":{"A":"73","B":"75","C":"77","D":"79"},"richtig":"C","erklaerung":"100 - 37 = 63, dann 63 + 14 = 77.","seq":"100 - 37 + 14 = ?"},
    {"kategorie":"Konzentration","schwierigkeit":2,"frage":"Ein Auto faehrt 120 km/h. Wie weit in 90 Minuten?","antworten":{"A":"150 km","B":"160 km","C":"170 km","D":"180 km"},"richtig":"D","erklaerung":"90 Minuten = 1,5 Stunden. 120 x 1,5 = 180 km.","seq":None},
    {"kategorie":"Konzentration","schwierigkeit":1,"frage":"Wie viele gerade Zahlen gibt es zwischen 1 und 10?","antworten":{"A":"4","B":"5","C":"6","D":"7"},"richtig":"B","erklaerung":"2, 4, 6, 8, 10 – das sind 5 gerade Zahlen zwischen 1 und 10.","seq":None},
    {"kategorie":"Konzentration","schwierigkeit":3,"frage":"4² + 3³ = ?","antworten":{"A":"41","B":"43","C":"45","D":"47"},"richtig":"B","erklaerung":"4² = 16, 3³ = 27, dann 16 + 27 = 43.","seq":"4² + 3³ = ?"},

    # ── GESCHICHTE NEU ────────────────────────────────────────────────────────
    {"kategorie":"Geschichte","schwierigkeit":1,"frage":"Wer war der erste Praesident der USA?","antworten":{"A":"Abraham Lincoln","B":"Thomas Jefferson","C":"George Washington","D":"Benjamin Franklin"},"richtig":"C","erklaerung":"George Washington war von 1789 bis 1797 der erste Praesident der USA.","seq":None},
    {"kategorie":"Geschichte","schwierigkeit":2,"frage":"In welchem Jahr wurde die Titanic gebaut (Stapellauf)?","antworten":{"A":"1909","B":"1910","C":"1911","D":"1912"},"richtig":"C","erklaerung":"Die Titanic lief am 31. Mai 1911 vom Stapel – gesunken ist sie 1912.","seq":None},
    {"kategorie":"Geschichte","schwierigkeit":2,"frage":"Welches Land schickte den ersten Menschen ins All?","antworten":{"A":"USA","B":"Deutschland","C":"China","D":"Sowjetunion"},"richtig":"D","erklaerung":"Juri Gagarin aus der Sowjetunion flog am 12. April 1961 als erster Mensch ins All.","seq":None},
    {"kategorie":"Geschichte","schwierigkeit":3,"frage":"Welcher Vertrag beendete den Ersten Weltkrieg offiziell?","antworten":{"A":"Versailler Vertrag","B":"Pariser Vertrag","C":"Berliner Vertrag","D":"Genfer Vertrag"},"richtig":"A","erklaerung":"Der Versailler Vertrag wurde am 28. Juni 1919 unterzeichnet und beendete den WWI.","seq":None},
    {"kategorie":"Geschichte","schwierigkeit":1,"frage":"Wie hiess der Pharao, der die groesste Pyramide baute?","antworten":{"A":"Ramses II","B":"Tutanchamun","C":"Cheops","D":"Cleopatra"},"richtig":"C","erklaerung":"Pharao Cheops liess die Grosse Pyramide von Gizeh um 2560 v.Chr. erbauen.","seq":None},

    # ── SPORT NEU ─────────────────────────────────────────────────────────────
    {"kategorie":"Sport","schwierigkeit":1,"frage":"Wie viele Spieler hat eine Rugby-Mannschaft?","antworten":{"A":"11","B":"13","C":"15","D":"18"},"richtig":"C","erklaerung":"Rugby Union wird mit 15 Spielern pro Mannschaft gespielt.","seq":None},
    {"kategorie":"Sport","schwierigkeit":2,"frage":"In welcher Stadt fanden die Olympischen Spiele 2020 statt?","antworten":{"A":"Paris","B":"Tokio","C":"Seoul","D":"Peking"},"richtig":"B","erklaerung":"Die Olympischen Spiele 2020 fanden 2021 in Tokio statt (wegen COVID verschoben).","seq":None},
    {"kategorie":"Sport","schwierigkeit":1,"frage":"Wie viele Punkte gibt ein Tor beim Fussball?","antworten":{"A":"1","B":"2","C":"3","D":"5"},"richtig":"A","erklaerung":"Jedes Tor zaehlt 1 Punkt (Tor). Die Punkte fuer die Tabelle sind 3/1/0.","seq":None},
    {"kategorie":"Sport","schwierigkeit":2,"frage":"Welcher Schwimmer hat die meisten Olympischen Goldmedaillen?","antworten":{"A":"Ian Thorpe","B":"Mark Spitz","C":"Michael Phelps","D":"Ryan Lochte"},"richtig":"C","erklaerung":"Michael Phelps hat 23 Olympische Goldmedaillen – ein weltweiter Rekord.","seq":None},
    {"kategorie":"Sport","schwierigkeit":3,"frage":"In welchem Jahr gewann Deutschland seine erste Fussball-WM?","antworten":{"A":"1950","B":"1954","C":"1958","D":"1962"},"richtig":"B","erklaerung":"Deutschland gewann 1954 die WM in der Schweiz – das Wunder von Bern.","seq":None},

    # ── MUSIK NEU ─────────────────────────────────────────────────────────────
    {"kategorie":"Musik","schwierigkeit":1,"frage":"Wie viele Tasten hat ein Standard-Piano?","antworten":{"A":"76","B":"80","C":"88","D":"96"},"richtig":"C","erklaerung":"Ein Standard-Piano hat 88 Tasten: 52 weisse und 36 schwarze.","seq":None},
    {"kategorie":"Musik","schwierigkeit":2,"frage":"Welcher Kuenstler ist als 'The King of Rock and Roll' bekannt?","antworten":{"A":"Chuck Berry","B":"Elvis Presley","C":"Jerry Lee Lewis","D":"Little Richard"},"richtig":"B","erklaerung":"Elvis Presley wird als 'The King of Rock and Roll' bezeichnet.","seq":None},
    {"kategorie":"Musik","schwierigkeit":2,"frage":"Was ist BPM in der Musik?","antworten":{"A":"Bass Pro Minute","B":"Beats Per Measure","C":"Beats Per Minute","D":"Base Pitch Mode"},"richtig":"C","erklaerung":"BPM steht fuer 'Beats Per Minute' – ein Mass fuer das Tempo eines Stuecks.","seq":None},
    {"kategorie":"Musik","schwierigkeit":1,"frage":"Welches Instrument spielt man mit einem Bogen?","antworten":{"A":"Gitarre","B":"Harfe","C":"Geige","D":"Banjo"},"richtig":"C","erklaerung":"Die Geige (Violine) wird mit einem Bogen gespielt – einem Haarbogen.","seq":None},
    {"kategorie":"Musik","schwierigkeit":3,"frage":"Welcher Komponist war taubstumm, schrieb aber die 9. Symphonie?","antworten":{"A":"Mozart","B":"Bach","C":"Schubert","D":"Beethoven"},"richtig":"D","erklaerung":"Beethoven schrieb die 9. Symphonie, als er bereits voellig taub war.","seq":None},

    # ── GEOGRAPHIE NEU ────────────────────────────────────────────────────────
    {"kategorie":"Geographie","schwierigkeit":1,"frage":"Welches Gebirge trennt Europa von Asien?","antworten":{"A":"Alpen","B":"Himalaya","C":"Ural","D":"Kaukasus"},"richtig":"C","erklaerung":"Der Ural gilt als natuerliche Grenze zwischen Europa und Asien.","seq":None},
    {"kategorie":"Geographie","schwierigkeit":2,"frage":"Welches ist das kleinste Land in Asien?","antworten":{"A":"Singapur","B":"Malediven","C":"Brunei","D":"Bhutan"},"richtig":"B","erklaerung":"Die Malediven sind mit 298 km² das flaechenmaessig kleinste Land Asiens.","seq":None},
    {"kategorie":"Geographie","schwierigkeit":1,"frage":"Was ist die Hauptstadt von Polen?","antworten":{"A":"Krakau","B":"Danzig","C":"Warschau","D":"Lodz"},"richtig":"C","erklaerung":"Warschau ist die Hauptstadt und groesste Stadt Polens.","seq":None},
    {"kategorie":"Geographie","schwierigkeit":2,"frage":"An welchem Meer liegt Barcelona?","antworten":{"A":"Atlantik","B":"Schwarzes Meer","C":"Nordsee","D":"Mittelmeer"},"richtig":"D","erklaerung":"Barcelona liegt am Mittelmeer an der Nordostkueste Spaniens.","seq":None},
    {"kategorie":"Geographie","schwierigkeit":3,"frage":"Welcher Fluss fliesst durch Budapest?","antworten":{"A":"Elbe","B":"Donau","C":"Rhein","D":"Weichsel"},"richtig":"B","erklaerung":"Die Donau teilt Budapest in Buda (West) und Pest (Ost).","seq":None},
]
